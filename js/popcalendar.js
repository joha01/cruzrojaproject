...
// Componente: PopCalendar.js(8.0.5)
// Correo: ricaj0625@yahoo.com
// �ltima actualizaci�n: 12 de diciembre de 2005
// Por favor mantenga estos cr�ditos (Please, keep these credits)

if(typeof(objPopCalList)=='undefined')
{
	var objPopCalList=[]
	var PopCalendar={majorVersion:8,minorVersion:0.5,newCalendar:new Function("_name","return(PopCalGetCalendarInstance(_name))")}
}
...
function PopCalConstructYear(l)
{
	...
	if(!objPopCal.yearConstructed)
	{
		...
		if(longList)
		{
			sHTML+="<tr><td align='center' class='OptionStyle' onmouseover='objPopCalList["+l+"].bShow=true;this.className=\"OptionOverStyle\"' onmouseout='objPopCalList["+l+"].bShow=false;clearInterval(objPopCalList["+l+"].intervalID2);this.className=\"OptionOutStyle\"' style='cursor:default;border-top:1px #a0a0a0 solid;' onmousedown='clearInterval(objPopCalList["+l+"].intervalID2);objPopCalList["+l+"].intervalID2=setInterval(\"PopCalIncYear("+l+")\",10)' onmouseup='clearInterval(objPopCalList["+l+"].intervalID2)'><img id='popupSuperDownYear' ondrag='return(false)' src='"+objPopCal.imgDir+"down.gif' border='0' alt='' /></td></tr>"
		}
		var PopCal=objPopCal.Object
...
function PopCalConstructCalendar(l)
{
	...
	{
		PopCalGetById("popupSuperSpanMonth"+PopCal.id).innerHTML="&nbsp;"+objPopCal.monthName[objPopCal.monthSelected]+"&nbsp;<img id='popupSuperChangeMonth"+PopCal.id+"' ondrag='return(false)' src='"+objPopCal.imgDir+"drop1.gif' width='12' height='10' border='0' alt='' />"
		PopCalGetById("popupSuperSpanYear"+PopCal.id).innerHTML="&nbsp;"+objPopCal.yearSelected+"&nbsp;<img id='popupSuperChangeYear"+PopCal.id+"' ondrag='return(false)' src='"+objPopCal.imgDir+"drop1.gif' width='12' height='10' border='0' alt='' />"
	}
	else
	{
