...
$css = array(
    ...
    base_url().'/resources/bootstrap-3.2.0/css/bootstrap-theme.min.css',
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
              <li class="active"><a href="<?= base_url().'auth/create_user'?>">Nuevo Usuario</a></li>
