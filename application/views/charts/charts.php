...
echo Open('div', array('class'=>'row'));
   ...
   echo form_open("charts/active_record");?>
    <p>
    <label for="example1">Desde</label> 
    <input  class="datepicker" type="text" placeholder="Fecha Inicio"  id="example1" name="fechainicio">

            
    <label for="example11">Hasta</label>            
    <input  class="datepicker" type="text" placeholder="Fecha Fin"  id="example11" name="fechafin">
        <script type="text/javascript">
