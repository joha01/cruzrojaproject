...
class Cliente_nusoap_2 extends CI_Controller {
   ...
   function call_crear_botonpanico() {
      ...
      $this->client = new nusoap_client('http://localhost/cruzrojaproject/servidor3_nusoap/index/wsdl', 'wsdl',
      ...
      $call = 'Servidor3_nusoap..crear_botonpanico';
